        ...
        <v-navigation-drawer enable-resize-watcher :permanent="modeDesktop" v-model="drawer" app color="#F6FBF6" height="100%" :dark="true">
            ...
            <v-list class="Heiti fs13">
                ...
                <v-list-group group="sales"  v-privilege="'user'">
                    ...
                    <div style="box-shadow: inset 3px 2px 20px #e4e4e4;">
                        <v-list-item to="/sales-order"  v-privilege="'so'">
                        <v-list-item-content class="p-icon-nav"> Sales Order </v-list-item-content>
                        </v-list-item>
                        <hr class="mx-9 hr-navbar" v-privilege="'so'">
                ...
                <v-list-group group="warehouse">
                    ...
                    <div style="box-shadow: inset 3px 2px 20px #e4e4e4;">
                        ...
                        <hr class="mx-9 hr-navbar" v-privilege="'stc'">
                        <v-list-item to="/warehouse/delivery-order"  v-privilege="'do'">
                            <v-list-item-content class="p-icon-nav"> Delivery Order </v-list-item-content>
                        </v-list-item>
                        <hr class="mx-9 hr-navbar" v-privilege="'do'">
                    </div>
                </v-list-group>

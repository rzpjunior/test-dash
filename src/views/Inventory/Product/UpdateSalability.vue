                ...
                <v-col>
                    ...
                    <v-row>
                        <v-col>
                            ...
                            <div style="margin-top:-20px;margin-left:54px" v-if="data.salability == 1">
                                <v-checkbox
...
export default {
    ...
    methods : {
        confirmButton() {
            this.ConfirmData = {
                model : true,
                title : "Update Product - Salability",
                text : "Are you sure you want to update this product salability?",
                urlApi : "/inventory/product/salability/"+this.$route.params.id,
        ...
        renderData() {
            this.$http.get("/inventory/product/"+ this.$route.params.id).then(response => {
                ...
                this.data.salability = this.items.salability
                this.data.warehouse = this.items.warehouse_sal_arr
